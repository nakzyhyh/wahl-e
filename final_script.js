...
const parties = [
  {
    ...
    coreMessage: "Die SPD setzt auf soziale Gerechtigkeit ..."
  },
  {
    name: "CDU/CSU",
    answers: {
      ...
      "24": "Neutral", "25": "Nein", "27": "Nein", "28": "Ja", "29": "Ja",
      "30": "Nein", "31": "Nein", "32": "Nein", "33": "Ja", "34": "Nein",
      "35": "Nein", "36": "Ja", "37": "Nein", "38": "Nein", "39": "Ja",
      "40": "Ja", "41": "Nein", "42": "Ja", "43": "Nein", "44": "Nein",
      "45": "Ja", "46": "Ja"
    },
    coreMessage: "Die CDU/CSU steht für wirtschaftsfreundliche Politik ..."
  },
  {
  ...
  },
  {
    ...
    answers: {
      ...
      "15": "Nein", "16": "Nein", "17": "Ja", "18": "Nein", "19": "Nein",
      "20": "Neutral", "21": "Nein", "22": "Ja", "23": "Nein", "24": "Nein",
      "25": "Ja", "27": "Nein", "28": "Ja", "29": "Ja", "30": "Ja",
      "31": "Nein", "32": "Nein", "33": "Ja", "34": "Nein", "35": "Nein",
      "36": "Ja", "37": "Ja", "38": "Nein", "39": "Ja", "40": "Ja",
      "41": "Nein", "42": "Ja", "43": "Nein", "44": "Nein", "45": "Nein",
      "46": "Ja"
    },
    coreMessage: "Die FDP betont die Bedeutung von wirtschaftlicher Freiheit ..."
  },
  {
    name: "AfD",
    answers: {
  ...
  },
  {
    ...
    coreMessage: "Die Linke steht für soziale Gerechtigkeit ..."
  },
  {
    ...
    answers: {
      ...
      "37": "Ja", "38": "Nein", "39": "Ja", "40": "Ja", "41": "Ja",
      "42": "Ja", "43": "Ja", "44": "Nein", "45": "Nein", "46": "Ja"
    },
 ...
 */
const coreMessages = {
  "SPD": "Die SPD setzt auf soziale Gerechtigkeit ...",
  "CDU/CSU": "Die CDU/CSU vertritt eine konservative ...",
  "Bündnis 90/Die Grünen": "Die Grünen legen ihren Schwerpunkt auf Klimaschutz ...",
  "FDP": "Die FDP betont die Bedeutung von wirtschaftlicher Freiheit ...",
  "AfD": "Die AfD vertritt eine stark konservative ...",
  "Die Linke": "Die Linke steht für soziale Gerechtigkeit ...",
  "Bündnis Sahra Wagenknecht (BSW)": "Das Bündnis Sahra Wagenknecht (BSW) setzt sich für ..."
};
...
/**
 * START-DOWNCOUNT-FUNKTION (Neuwahlen am 23. Februar 2025)
 */
function startCountdown() {
  ...
  function updateCountdown() {
    ...
    // Stunden (Rest nach Herausrechnen ganzer Tage)
    const hours = Math.floor(
      (timeLeft % (1000 * 60 * 60 * 24)) / (1000 * 60 * 60)
    );
  
    // Minuten (Rest nach Herausrechnen ganzer Stunden)
    const minutes = Math.floor(
      (timeLeft % (1000 * 60 * 60)) / (1000 * 60)
    );
  
    // Sekunden (Rest nach Herausrechnen ganzer Minuten)
...
function startQuiz() {
  ...
  if (questionContainer) {
    // Frage-Bereich sichtbar machen
    questionContainer.classList.remove("hidden");
    questionContainer.style.display = "block";
    
    // **Hier der automatische Scroll**
...
function showQuestion(index) {
  ...
  question.options.forEach((option) => {
    ...
    // Markiere bereits gewählte Option
    ...
    button.addEventListener("click", () => {
      ...
      goForward(); // Automatisch weiter zur nächsten Frage
    });
...
function showResults() {
  ...
  // Fragebereich verstecken
  const questionContainer = document.getElementById("question-container");
  if (questionContainer) {
    questionContainer.classList.add("hidden");
  }

  // Ergebnis-Sektion sichtbar machen
  const resultSection = document.getElementById("result-section");
  if (resultSection) {
    resultSection.classList.remove("hidden");
  }

  // Modal (Themengewichtung) anzeigen
  const weightModal = document.getElementById("weight-and-explanation");
  if (weightModal) {
    weightModal.classList.remove("hidden");
  } else {
    console.error("❌ Themenprioritäten-Modal wurde nicht gefunden.");
  }
}

/**
 * HAUPT-BERECHNUNG MIT GEWICHTUNG
 */
  ...
  return parties
    .map((party) => {
      ...
      questions.forEach((question) => {
        ...
        // Aus den categoryWeights holen wir das Gewicht
        const categoryFactor = categoryWeights[question.category] || 1;
        // question.weight * categoryFactor (z. B. 1 * 1.5)
...
function renderResults(results) {
  ...
  results.forEach((result) => {
    ...
    // Logo-Pfad aus partyLogos-Objekt (falls kein Logo-Eintrag vorhanden => fallback)
    const logoSrc = partyLogos[result.party] || ""; // oder "fallback.jpg"

    // Wir bauen den Ergebnis-Block inkl. Logo + Parteiname nebeneinander:
    const barHtml = `
      <div class="match-bar">
    ...
    const detailsHtml = `
      <div class="party-details">
        ...
        <div class="details-content" style="max-height: 0;">
    ...
    // Falls du das Logo links vom Parteinamen möchtest:
    card.innerHTML = `
  ...
  // Optional: Farbgebung anpassen (Parteiname -> bestimmte Farben, etc.)
  document.querySelectorAll(".result-card").forEach((card) => {
    ...
    if (partyNameElement) {
      ...
      // Beispiel-Farbzuordnungen (kannst du löschen/ergänzen)
      const partiesMap = {
        cdu: "#1D7874",
        afd: "#005bbb",
        spd: "#bb0000",
...
/**
 * THEMENPRIORITÄTEN ANWENDEN
 * Liest die Sliderwerte aus (z. B. climateSlider) und updatet categoryWeights.
 */
function applyWeights() {
  const sliders = document.querySelectorAll(".slider-group input[type='range']");
  sliders.forEach((slider) => {
    // z. B. "climateSlider" -> "climate"
  ...
  // Ergebnisse neu berechnen und darstellen
  const results = calculateResults();
  renderResults(results);
